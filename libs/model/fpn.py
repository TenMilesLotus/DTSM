...
from .text_query_encoder import Text_query_encoder
...
class FPN(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        # TQE
        self.text_query_encoder = Text_query_encoder(8, 256, 2, 0.2, 256)


    def forward(self, feats, text_masks):
    # def forward(self, feats):
        c2, c3, c4, c5 = feats
        p5 = self.lat_layers[3](c5)  # torch.Size([1, 256, 57, 63])
        # text_mask
        p5 = self.text_query_encoder(p5, text_masks)
