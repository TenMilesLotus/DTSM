...
class SegmentPredictor(nn.Module):
    ...
    def forward(self, feats, images_size, fg_spans=None, bg_spans=None, text_feats=None):
        ...
        if self.training:
            targets = gen_targets(images_size, self.scale, feats.device, fg_spans, bg_spans, self.type)  # gt mask b h w
